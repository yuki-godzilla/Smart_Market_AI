...
- Next focus is to continue Phase 21.6 / 21.7 external source breadth or Phase 22 Research Score carefully while preserving unchanged default ranking order. Phase 21.5 Stock News RAG covers selected-symbol cockpit news evidence from local URL-backed news documents. Phase 21.6 / 21.7 now use session-local live evidence for summary / score / display only. EDINET / TDnet / company IR site adapters, explicit save/archive UI, broader Investment News dashboard, Assistant, distribution readiness, and Execution/Broker integration remain planned or future scope unless explicitly assigned.
