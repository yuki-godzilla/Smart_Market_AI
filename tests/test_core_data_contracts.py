...
def test_fundamental_snapshot_accepts_provider_fields():
    ...
    assert snapshot.dividend_yield == Decimal("0.005")
    assert snapshot.market_cap_jpy == Decimal("450000000000000")
