...
_TASK_DEFAULTS: dict[LlmTaskType, LlmProfileName] = {
    ...
    "radar_overview_interpretation": "desktop_fast",
    "news_interpretation": "desktop_fast",
    "ranking_interpretation": "desktop_fast",
...
_QUALITY_UPGRADES: dict[LlmTaskType, LlmProfileName] = {
    ...
    "radar_overview_interpretation": "desktop_analysis",
    "news_interpretation": "desktop_analysis",
    "ranking_interpretation": "desktop_analysis",
    "decision_report_draft": "desktop_heavy",
    "report_export_summary": "desktop_heavy",
...
_TASK_RUNTIME_POLICIES: dict[LlmTaskType, tuple[float, int]] = {
    ...
    "radar_overview_interpretation": (45.0, 1200),
    "news_interpretation": (45.0, 1200),
    "ranking_interpretation": (45.0, 1200),
...
_MODEL_TASK_TOKEN_POLICIES: dict[str, dict[LlmTaskType, int]] = {
    "qwen3:1.7b": {
        ...
        "radar_overview_interpretation": 800,
        "ranking_interpretation": 800,
    ...
    "qwen3:4b": {
        ...
        "radar_overview_interpretation": 1000,
        "ranking_interpretation": 1000,
    ...
    "qwen3:8b": {
        ...
        "radar_overview_interpretation": 1200,
        "ranking_interpretation": 1200,
    ...
    "qwen3:14b": {
        ...
        "radar_overview_interpretation": 1500,
        "ranking_interpretation": 1500,
    ...
    "qwen3:30b": {
        ...
        "radar_overview_interpretation": 1700,
        "ranking_interpretation": 1700,
