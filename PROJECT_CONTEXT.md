...
- Continue Phase 18 by expanding official/curated source data with broader JPX coverage, SBI stock/ETF lists, ETF metadata, and NISA list files. The current import command has JPX/SBI/NISA profiles, and the candidate master has 146 rows after SBI US stock/ETF and future mutual-fund seed import, while default ranking only includes stock / ETF rows.
