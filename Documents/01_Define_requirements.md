...
## 2. Scope
- **対象市場**
  - *初期ユニバース*: SBI証券で取り扱いがあり、現物・NISA・長期投資で検討しやすい国内株式、米国株式、国内ETF、米国ETF/海外ETF、投資信託、REIT
  - *投資枠*: 高配当・割安・成長・低リスクなどの観点で比較する個別株 / ETF / REIT
  - *積立枠*: 安定成長する投資信託、低コストETF、NISAつみたて投資枠対象商品
