...
- Cockpit Research Summary の主表示順は、SMAI 投資判断サマリー -> 3カラム判断材料（良い材料 / 注意材料 / まだ判断に足りない情報）-> folded 根拠確認（AI整理メモ / 読み方サマリー / 会社概要 / 確認できた事実 / 公式資料で未確認）とする。出典カード、Research Score、件数、confidence、詳細データは必要時に開く補助情報へ下げる。
