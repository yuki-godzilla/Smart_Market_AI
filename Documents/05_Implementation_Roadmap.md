...
- Cockpit Research Summary の主表示順は、企業リサーチサマリー -> 定量情報サマリー -> IR情報サマリー -> 最新ニュースサマリー -> 企業理解の確認ポイント -> folded AI読み取りメモ / 3カラム確認情報（確認できた情報 / 注意して読む情報 / 不足している情報）-> folded 根拠確認（AI整理メモ / 読み方サマリー / 会社概要 / 確認できた事実 / 公式資料で未確認）とする。出典カード、Research Score、件数、confidence、詳細データは必要時に開く補助情報へ下げる。
