...
| Phase N1〜N4 / Notification Platform | 🟦 **N1〜N4実装済み / N5 Producer未着手** | schema v2通知履歴、保存優先service、右上通知センター、ユーザー/マスコット/Trusted Device、明示テスト通知まで実装。自動Producerは未接続。 |
...
5. N4: SQLite 通知履歴、未読 / 既読 / archive、右上通知センター、Trusted Device（実装済み）
