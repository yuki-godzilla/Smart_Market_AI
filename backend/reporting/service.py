...
_DISPLAY_KEY_LABELS = {
    ...
    "asset_type": "商品分類",
    "currency": "通貨",
    "reversal_expectation_score": "上向き兆候",
    "reversal_expectation_label": "上向き兆候ラベル",
    "reversal_expectation_reason": "上向き兆候理由",
    "reversal_chart_shape_score": "チャート形状スコア",
    "reversal_chart_shape_label": "チャート形状",
    "reversal_forecast_score": "上向き余地",
    "reversal_safety_score": "下落安全性",
    "reversal_pullback_score": "調整・安定度",
    "reversal_quality_score": "企業・データ・配当品質",
    "reversal_material_score": "上向き材料",
    "reversal_trap_warning": "上向き兆候の注意",
    "dividend_trap_warning": "配当罠警戒",
    "nisa_category": "NISA",
