...
| UX-014 | Research Summary / Evidence | 資料がある銘柄を確認する | 登録資料ありの銘柄で Research Summary を表示する | 資料名、日付、根拠数、抜粋が確認できる | 根拠の鮮度や信頼度が分かりにくい | Data Confidence | High | Not tested | 公式資料か provider snapshot か |
| UX-015 | Research Summary / Evidence | 資料がない銘柄を確認する | 資料未登録の銘柄で Research Summary を実行する | 根拠不足として控えめに扱うことが分かる | 情報なしが低評価に見える | Spec Ambiguity | Medium | Not tested | Research Score前提も確認 |
...
| UX-021 | Score explanation / confidence / coverage | Score hierarchy を確認する | Investment Score、Screening、Forecast、Risk、Data Qualityを横断して読む | どの指標が投資魅力度で、どれが信頼度か区別できる | スコアが多く、上下関係が分からない | Spec Ambiguity | High | Not tested | 97台帳にも記載 |
