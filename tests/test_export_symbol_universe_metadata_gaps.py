...
MODULE_PATH = Path(__file__).resolve().parents[1] / "tools" / "export_symbol_universe_metadata_gaps.py"
...
def test_build_gap_candidates_filters_market_and_missing_metrics():
    rows = [
        {"symbol": "A", "name": "Alpha", "market": "korea", "asset_type": "stock", "pbr": "", "per": "10"},
        {"symbol": "B", "name": "Beta", "market": "jp", "asset_type": "stock", "pbr": "", "per": ""},
        {"symbol": "C", "name": "Gamma", "market": "korea", "asset_type": "stock", "pbr": "1.2", "per": "12"},
    ]
