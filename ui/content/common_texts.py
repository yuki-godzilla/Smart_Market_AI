...
MARKET_DATA_PERIOD_HELP_TEXT = {
    MARKET_DATA_PERIOD_CUSTOM: "見たい期間を自由に指定します。",
    "short_1w": "決算・ニュース後の短期反応を見る期間です。",
    "short_1m": "直近の勢いと需給の変化を見ます。",
    "medium_3m": "決算後の評価変化とトレンドを見ます。",
    "medium_6m": "半期のトレンドと下落局面を見ます。",
    "ytd": "年初来の相場で強さを比べます。",
    "long_1y": "直近1年のトレンドと業績期待を見ます。",
    "long_3y": "複数の決算期をまたぐ成長と景気感応度を見ます。",
    "long_5y": "長期の変化、下落幅、回復力を見ます。",
}
