...
成熟済みpointを含み、Rolling Conformalの`--evaluation-role new_sealed_audit`へ渡せる。100件/horizon到達は
評価開始条件であり、自動採用条件ではない。詳細は`Documents/44_Forecast_Sealed_Audit_Backend.md`を参照する。
