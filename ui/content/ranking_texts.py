...
RANKING_CHART_PROFILE_TEXTS: dict[str, RankingChartProfileText] = {
    "reversal_expectation": {
        "title": "上向き兆候マップ（形状 × 余地）",
        "description": "チャート形状の強さと上向き余地を、下落安全性・データ信頼度と合わせて確認します。両軸がばらつく候補だけを表示します。",
        "how_to_read": (
            "右上: 形状と上向き余地がともに強く、まず詳細を確認する候補",
            "左上: 予測材料はあるが、形状の確認が必要な候補",
            "右下: 形状は整いつつあるが、上向き材料が弱めの候補",
            "左下: 形状・上向き材料ともに弱めの候補",
        ),
        "caution": "色は下落安全性です。軸が同じ値に偏る場合は、上昇気配 × 下降警戒の代替マップへ切り替えます。上位でも反発を断定せず、下落理由と配当維持力を確認してください。",
    },
    "score_risk": {
        "title": "スコア x リスク",
