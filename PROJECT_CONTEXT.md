...
- Next focus is to continue Phase 21.6 / 21.7 external fetch maturity or Phase 22 Research Score carefully while preserving unchanged default ranking order. Phase 21.5 Stock News RAG covers selected-symbol cockpit news evidence from local URL-backed news documents. Phase 21.6 / 21.7 have a first Cockpit UI slice for explicit opt-in Yahoo Finance external research/news fetch, local cache registration, chunk rebuild, manifest output, source display, and network-free fake-adapter tests. EDINET / TDnet / company IR site adapters, cache retention / cleanup UI, broader Investment News dashboard, Assistant, distribution readiness, and Execution/Broker integration remain planned or future scope unless explicitly assigned.
