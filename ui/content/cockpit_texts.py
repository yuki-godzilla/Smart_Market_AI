...
COCKPIT_SCORE_EVALUATION_TABLE = {
    "investment_score": (
        (Decimal("75"), "高め。比較・分析上の確認優先度が高い状態です。"),
        (Decimal("65"), "やや高め。内訳、予測、リスクを合わせて確認します。"),
        (Decimal("45"), "中立圏。決め手よりも内訳の偏りを確認します。"),
        (Decimal("0"), "低め。データ不足や警戒材料を先に確認します。"),
    ),
    "upside_signal_score": (
    ...
    "risk": (
        (Decimal("75"), "落ち着き。今回の期間では値動き確認材料は比較的安定しています。"),
        (Decimal("65"), "やや落ち着き。安全保証ではなく、値動きと警告を確認します。"),
