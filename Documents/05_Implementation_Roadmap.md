...
| Phase 32-C2 / Watchlist UI Polish | 🟦 **MVP実装済み** | 登録済みお気に入りボタンをゴールド系で明確化。Myウォッチリストカードをヘッダー / 状態バッジ / メトリクス / 確認情報へ整理し、専用 `watchlist` mascot asset filename と未配置fallbackを追加。 |
