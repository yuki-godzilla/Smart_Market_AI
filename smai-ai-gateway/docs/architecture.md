...
- Assistant startup warmup、readiness state、loading panel、Investment Radar cache headlinesは親SMAI側の責務とする。Gatewayは既存 `/models` をreadiness確認に提供し、新しいSMAI専用endpointやSMAI Python importは追加しない
