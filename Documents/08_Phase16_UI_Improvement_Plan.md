...
- Rebalance tab で、JSON input を advanced input に移動し、summary flow、percentage target、allocation comparison chart、risk breach confirmation points、latest result persistence を追加。
