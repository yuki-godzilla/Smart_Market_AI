...
MARKET_DATA_RANKING_UPDATED_AT_STATE_KEY = "market_data_ranking_updated_at"
...
MARKET_DATA_EXTERNAL_RESEARCH_FETCH_STATE_KEY = "market_data_external_research_fetch"
