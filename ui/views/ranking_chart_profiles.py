...
RANKING_CHART_PROFILES: dict[str, RankingChartProfile] = {
    ...
    PROFILE_SCORE_FORECAST: RankingChartProfile(
        ...
        title="Score x Forecast Map",
        x_candidates=("総合スコア", "Investment Score"),
        y_candidates=("予測一致", "Forecast Agreement"),
        color_candidates=("見方", "注意点"),
        description="スコアが高い候補について、予測モデルの見方がどれくらい揃っているかを確認できます。",
        how_to_read=(
            "High score / High forecast: 深掘りしやすい候補",
            "High score / Low forecast: 予測の不一致を確認",
            "Low score / High forecast: 予測は安定しているが総合点は低め",
            "Low score / Low forecast: 優先度低め",
        ),
    ),
    ...
    PROFILE_MOMENTUM_FORECAST: RankingChartProfile(
        ...
        title="Momentum x Forecast Map",
        x_candidates=("Momentum Score", "モメンタム", "Screening"),
        y_candidates=("予測一致", "Forecast Agreement"),
        color_candidates=("見方", "注意点"),
        fallback_key=PROFILE_SCORE_FORECAST,
        description="足元の勢いがある候補について、予測モデルの見方もあわせて確認できます。",
        how_to_read=(
            "High momentum / High forecast: トレンド観点で深掘りしやすい候補",
            "High momentum / Low forecast: モデル不一致を確認",
            "Low momentum / High forecast: 予測は安定しているが勢いは弱め",
            "Low momentum / Low forecast: 優先度低め",
        ),
    ),
