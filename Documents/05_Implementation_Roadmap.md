...
- Cockpit Research Summary の主表示順は、AI整理メモ -> 読み方サマリー -> 3つの確認ポイント（会社概要 / 確認できた事実 / 公式資料で未確認）-> 確認不足 -> 次に確認すべき資料 とする。良材料候補 / 注意材料候補、出典カード、Research Score、件数、confidence、詳細データは必要時に開く補助情報へ下げる。
