...
- 2026-06-09: Improved the Cockpit `AI予測インサイト` card so `中心予測` is the primary display, downside / center / upside cases replace weak / median / strong wording, case tooltips explain the assumptions, low-confidence / hold states get amber emphasis, individual advanced model lines are checkbox-addable on the chart, and advanced model cards remain visible under the chart.
