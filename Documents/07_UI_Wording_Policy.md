...
- Direction Signal は「上がる銘柄/下がる銘柄」ではなく、「上昇気配」「下降警戒」「深掘り候補」として表現する。`反転期待` は Direction Signal に混ぜず、直近下落・調整中の銘柄を戻り候補として確認する独立探索軸として扱う。
...
| `反転期待` | 押し目状態、予測余地、下落安全性、品質、反転初動から戻り候補の確認価値を整理する独立指標 | 「買い」「底打ち」と断定せず、下落理由を深掘りする優先度として説明する |
