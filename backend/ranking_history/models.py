...
class RankingHistoryResultRow(StrictBaseModel):
    ...
    reversal_chart_shape_score: float | None = None
    reversal_forecast_score: float | None = None
    reversal_safety_score: float | None = None
    reversal_pullback_score: float | None = None
    reversal_quality_score: float | None = None
    reversal_material_score: float | None = None
