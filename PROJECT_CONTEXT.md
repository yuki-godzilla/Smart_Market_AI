...
- Continue Phase 18 by expanding official/curated source ingestion with broader JPX coverage, SBI stock/ETF lists, ETF metadata, and NISA lists. The current candidate master has 146 rows after SBI US stock/ETF and future mutual-fund seed import, while default ranking only includes stock / ETF rows.
