...
- Phase 19 is complete; Phase 20 local Research RAG evidence work is implementation-complete; Phase 21 Advanced Research RAG / Stock News RAG MVP and the first Phase 22 Research Score / disabled-by-default Investment Score input slices are implemented; later Phase 22+ ranking/report integration, assistant, optional adapters, and execution gate remain planned.
