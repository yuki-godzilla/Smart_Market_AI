...
2026-05-17 時点では、SMAI は Phase 15 まで概ね実装済み、Phase 16 UI 改善中、Research RAG は planned、Execution は deferred です。
...
- 期待するユーザー視点の変化:
- 対象フェーズ:
  - Phase 16 UI polish / Decision Report preparation / Research RAG R1-R3 / bugfix / docs-only など
