...
| Phase 30 | 🟨 **MVP済み / 継続拡張** | SMAI Assistant Tool Plan MVP。画面状態から次アクション候補を提案し、実行は確認前提に限定する。 |
...
- Phase 30-B: Tool Plan から Ranking / Cockpit / News への安全な navigation を確認付きで接続する。
